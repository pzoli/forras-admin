...
@Named
@Stateless
public class DocInfoService extends BasicService<DocInfo> implements
		Serializable {
	...
	@Override
	public DocInfo find(DocInfo item) {
		return em.find(DocInfo.class, item.getId());
	}
	...
	@Override
	public Class<DocInfo> getDomainClass() {
