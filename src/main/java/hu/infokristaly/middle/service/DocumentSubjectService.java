...
@Named
@Stateless
public class DocumentSubjectService extends BasicService<DocumentSubject> implements
		Serializable {
	...
	protected String buildQueryString(Map<String, Object> filters) {
		...
		queryBuff.append("from DocumentSubject");
	...
	@Override
	public DocumentSubject find(DocumentSubject item) {
		return em.find(DocumentSubject.class, item.getId());
	}
	...
	@Override
	public Class<DocumentSubject> getDomainClass() {
		return DocumentSubject.class;
	}
